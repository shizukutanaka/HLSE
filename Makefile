...
# Source files
CORE_SRC  := hlse_core.c hlse_selftest.c hlse_text.c hlse_protect.c hlse_secrets.c hlse_supply.c hlse_file.c hlse_audit.c hlse_util.c hlse_alert.c hlse_config.c
