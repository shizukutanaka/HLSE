...
| **Credential leak** | hlse_secrets.c | 34 token patterns — AWS (incl. STS), GitHub, GitLab, Google, npm, OpenAI/Anthropic, Stripe, Shopify, HuggingFace, PyPI, Postman, Square, Doppler, Grafana, Linear, New Relic, Databricks, Slack, SSH keys, .env passwords (excludes doc/example/placeholder keys to cut false positives) |
...
| Secrets | 33 | Credentials (34 token patterns), email headers, crypto addresses (incl. Solana) |
