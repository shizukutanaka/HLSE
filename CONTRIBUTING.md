...
1. Run `make test` before opening a PR. It must be **green** — 1211 checks,
...
|------|---------|------------------|
| Tests | `make test` | All 10 suites + property + corpus + CLI + daemon integration (1211, must be green) |
